...
class BudgetingUI:
    ...
    def initialize(self):
        ...
        new_budget_button.grid(row=1, column=0, padx=5, pady=5, sticky=constants.E)
...
class BudgetingListUI:
    ...
    def initialize_budget_item(self, budget):
        ...
        item_frame.grid(row=self._budgets.index(budget), column=0, padx=5, pady=5, sticky=constants.EW)
