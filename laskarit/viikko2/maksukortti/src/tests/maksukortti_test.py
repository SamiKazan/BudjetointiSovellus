...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_osta_halpa(self):
        kortii = Maksukortti(250)
        kortii.syo_edullisesti()

        self.assertEqual(kortii.saldo_euroina(), 0)

    def test_osta_maukas(self):
        kortii = Maksukortti(400)
        kortii.syo_maukkaasti()
